...
class placeStmt : public Statement
{
	...
	public:
		placeStmt(ExpNode *izqAux, ExpNode *drchAux){
			this->izq = izqAux;
			this->drch = drchAux;
		}
...
class entireDivisonOperatorNode : public NumericOperatorNode{
	public:
		
		entireDivisonOperatorNode(ExpNode* izq, ExpNode* drch) : NumericOperatorNode(izq, drch){};
