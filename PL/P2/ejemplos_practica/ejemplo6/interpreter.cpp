...
int main(int argc, char *argv[])
{
	...
	*/
	...
	setjmp(begin); /* El programa "salta" a donde apunta esta variable en caso de que exista algun error */

	/* The name of the function to handle floating-point errors is set */
	signal(SIGFPE,fpecatch); /* Se maneja el error llamando a fpecatch */
	/*********************************************************/
