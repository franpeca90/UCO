...
/* La dos numeros son iguales si es menor que una cota de error cercana a 0 */
...
exp:	NUMBER 
	...
	| 	exp DIVISION exp
		{	
	     ...
	     if (fabs($3) < ERROR_BOUND) /*Estamos controlando que por lo que divido sea distinto de 0. fabs da el valor absoluto del numero*/
