...
#line 1407 "interpreter.tab.c"
    break;

  case 7: /* exp: NUMBER  */
#line 87 "interpreter.y"
       { std::cout << "exp --> NUMBER" << std::endl;}
#line 1413 "interpreter.tab.c"
    break;

  case 8: /* exp: exp '+' exp  */
#line 90 "interpreter.y"
                { std::cout << "exp --> exp '+' exp" << std::endl;}
#line 1419 "interpreter.tab.c"
    break;

  case 9: /* exp: exp '-' exp  */
#line 93 "interpreter.y"
                { std::cout << "exp --> exp '-' exp" << std::endl;}
#line 1425 "interpreter.tab.c"
    break;

  case 10: /* exp: exp '*' exp  */
#line 96 "interpreter.y"
                { std::cout << "exp --> exp '*' exp" << std::endl;}
#line 1431 "interpreter.tab.c"
    break;

  case 11: /* exp: exp '/' exp  */
#line 99 "interpreter.y"
                { std::cout << "exp --> exp '/' exp" << std::endl;}
#line 1437 "interpreter.tab.c"
    break;
