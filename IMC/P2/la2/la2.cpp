...
int main(int argc, char **argv) {
    ...
    while ((c = getopt(argc, argv, "t:i:l:n:e:m:v:h:d:T:w:ofs:p")) != -1)
    {
    ...
    if (!pflag) {
        ...
        mlp.outputFunction = oflag; // Nos indica el tipo de salida

    	// Type of error considered
    	int error = errorType; // This should be completed
