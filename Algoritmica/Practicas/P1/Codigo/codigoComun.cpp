...
bool estaOrdenado(const vector<int> &v){
    // NOTA: Por problemas con el compilador de los PCs de la universidad, no me reconoce la funcion is_sorted
    // por lo que lo dejo comentado, al ser una parte no necesaria para realizar el los calculos de los tiempos
